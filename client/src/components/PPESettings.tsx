    ...
    <div className="bg-purple-50 rounded-lg p-3 sm:p-4 border border-purple-100">
      <div className="flex items-center mb-3 sm:mb-4">
        ...
        <div className="relative inline-block group">
          <div className="h-3.5 w-3.5 ml-1 cursor-help opacity-70 text-purple-500 hover:opacity-100">
            <svg 
      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <div className="mt-1 sm:mt-2">
          <div className="flex items-center mb-1 sm:mb-2">
            ...
            <div className="relative inline-block group">
              <div className="h-3 w-3 sm:h-3.5 sm:w-3.5 ml-1 cursor-help opacity-70 text-purple-500 hover:opacity-100">
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  className="h-full w-full" 
                  fill="none" 
